...
@section('title', __('Add Tournament Card'))

@section('content')
<div class="px-6 py-4 space-y-4">
  <div>
    <h1 class="text-xl font-semibold text-white">{{ __('Add Tournament Card') }}</h1>
    <p class="text-sm text-gray-400">{{ __('Create a new tournament card for the public tournaments page.') }}</p>
  </div>
